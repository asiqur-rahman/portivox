...
function printUsage(): void {
  ...
  console.log(
    [
      ...
      "  --exit-after <seconds>   Exit if the tunnel has not connected within this time",
      "  --heartbeat <ms>         Keep-alive interval (advanced)",
      "",
      "EXAMPLES",
      ...
      "  portivox open 22 --tcp                 # expose SSH over a public TCP port",
